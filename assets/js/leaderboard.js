...
async function updateLeaderboard(pageToLoad = 1) { // Add default argument for initial call
    ...
    entries.forEach((row) => {
      ...
      leaderboardEntries.innerHTML += `
          <tr class="leaderboard-row" id="${'rank-' + rankId++}">
              ...
              <td class="user-username">${row.guest_username}</td>
  ...
  // Call function with initial page
  updateLeaderboard();
